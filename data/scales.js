...
{id:'qsofa', title:'qSOFA', sub:'Sepsis — screening rápido (≥2 = alto riesgo)', badge:'red', tag:'Sepsis', max:3, items:[
...
{id:'curb65', title:'CURB-65', sub:'Neumonía — gravedad e ingreso', badge:'amber', tag:'Neumonía', max:5, items:[
...
{id:'wells', title:'Wells — TEP', sub:'Probabilidad pre-test de tromboembolismo', badge:'red', tag:'TEP', max:12.5, items:[
...
{id:'gbs', title:'Glasgow-Blatchford', sub:'HDA — Necesidad de intervención', badge:'amber', tag:'HDA', max:29, items:[
...
{id:'bisap', title:'BISAP', sub:'Pancreatitis aguda — mortalidad', badge:'amber', tag:'Pancreatitis', max:5, items:[
...
{id:'abcd2', title:'ABCD2', sub:'AIT — Riesgo de ictus a 2 días', badge:'red', tag:'AIT/Ictus', max:7, items:[
  {t:'chk', l:'A — Edad ≥60 años', p:1},
...
{id:'hasbled', title:'HAS-BLED', sub:'FA — riesgo hemorrágico bajo anticoagulación', badge:'blue', tag:'FA', max:9, items:[
...
{id:'spesi', title:'sPESI', sub:'TEP — mortalidad a 30 días (simplificado)', badge:'red', tag:'TEP', max:6, items:[
...
{id:'pesi', title:'PESI original', sub:'TEP — clases I–V de mortalidad a 30 días', badge:'red', tag:'TEP', max:310, items:[
...
{id:'geneva', title:'Ginebra revisado', sub:'TEP — probabilidad clínica pre-test', badge:'red', tag:'TEP', max:22, items:[
...
{id:'nihss', title:'NIHSS', sub:'Ictus — déficit neurológico (0–42)', badge:'red', tag:'Ictus', max:42, items:[
...
{id:'sofa', title:'SOFA', sub:'Disfunción orgánica (0–24) · Δ≥2 = sepsis', badge:'red', tag:'Sepsis', max:24, items:[
...
{id:'gcs', title:'Glasgow (GCS)', sub:'Nivel de conciencia (3–15)', badge:'red', tag:'Neuro', max:15, items:[
...
{id:'kdigo', title:'KDIGO — AKI', sub:'Fracaso renal agudo (estadio = criterio más alto)', badge:'amber', tag:'AKI', max:3, agg:'max', items:[
...
{id:'decaf', title:'DECAF', sub:'EPOC agudizado — mortalidad intrahospitalaria', badge:'amber', tag:'EPOC', max:6, items:[
...
{id:'at4', title:'4AT', sub:'Delirium — cribado rápido (≥4 = posible delirium)', badge:'amber', tag:'Delirium', max:12, items:[
...
{id:'rockall', title:'Rockall pre-endoscópico', sub:'HDA — riesgo previo a endoscopia (0–7)', badge:'amber', tag:'HDA', max:7, items:[
...
{id:'aims65', title:'AIMS65', sub:'HDA — mortalidad intrahospitalaria', badge:'amber', tag:'HDA', max:5, items:[
...
{id:'ranson', title:'Ranson (no biliar)', sub:'Pancreatitis — ingreso + 48 h (≥3 = grave)', badge:'amber', tag:'Pancreatitis', max:11, items:[
...
{id:'barthel', title:'Barthel', sub:'Situación funcional basal (0–100)', badge:'blue', tag:'Geriatría', max:100, items:[
...
{id:'downton', title:'Downton', sub:'Riesgo de caídas (≥3 = alto riesgo)', badge:'blue', tag:'Caídas', max:11, items:[
...
{id:'morse', title:'Morse', sub:'Riesgo de caídas intrahospitalario', badge:'blue', tag:'Caídas', max:125, items:[
...
{id:'anthonisen', title:'Anthonisen', sub:'EPOC agudizado — indicación de antibiótico', badge:'amber', tag:'EPOC', max:3, items:[
...
{id:'ehra', title:'EHRA', sub:'FA — clase funcional sintomática', badge:'blue', tag:'FA', max:5, items:[
...
{id:'bms', title:'Bacterial Meningitis Score', sub:'Pediátrico 29 días–19 años — solo si LCR pleocitosis', badge:'red', tag:'Meningitis', max:6, items:[
